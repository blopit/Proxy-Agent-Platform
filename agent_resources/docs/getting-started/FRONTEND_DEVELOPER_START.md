...
**OLD:** Next.js web frontend at `frontend/` (COMPLETELY REMOVED October 2025)
**NEW:** Expo/React Native mobile app at `mobile/` ← **START HERE**
...
### For Historical Reference (REMOVED Next.js Web App)

⚠️ **WARNING**: The Next.js web frontend was **COMPLETELY REMOVED** in October 2025. These docs describe **DELETED CODE**:

- [`docs/archive/2025-11-10-deprecated-arch/nextjs-web/FRONTEND_ARCHITECTURE.md`](./frontend/FRONTEND_ARCHITECTURE.md) - Removed web architecture
- [`docs/frontend/FRONTEND_PATTERNS.md`](./frontend/FRONTEND_PATTERNS.md) - Design patterns (concepts still applicable)
- [`docs/frontend/COMPONENT_PATTERNS.md`](./frontend/COMPONENT_PATTERNS.md) - Component patterns (concepts still applicable)

❌ **DO NOT** try to use Next.js patterns - they will not work with React Native!
