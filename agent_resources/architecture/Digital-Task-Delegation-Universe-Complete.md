...
## ⚙️ FRAME 6 — How Delegation Works (Flow Scene)
...
| Phase | Focus | Core Feature |
|-------|-------|--------------|
| **MVP (0.1)** | Personal Assistant | Intake + Decompose + Manual assignment |
| **v0.2** | Smart Delegation | Auto-matching tasks ↔ capable agents |
| **v0.3** | Execution | MCP tools for Gmail, Docs, Calendar |
| **v0.4** | Review Loop | Verification & Learning |
| **v0.5** | Marketplace | Invite other agents / plugins |
| **v1.0** | Open Agency | Fully autonomous digital workforce |
...
1. **A system architecture diagram (Mermaid)** showing all these components (agents, layers, pipelines),
or

2. **A product design doc (PRD)** describing MVP → v1.0 with API endpoints, database schema, and agent contracts?
