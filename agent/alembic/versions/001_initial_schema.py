...
def upgrade() -> None:
    ...
    energy_level_enum = postgresql.ENUM(
        "very_low", "low", "medium", "high", "very_high", name="energylevel"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "priority", task_priority_enum, server_default=sa.text("'medium'"), nullable=True
        ),
