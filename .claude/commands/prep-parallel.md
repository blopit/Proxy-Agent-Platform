---
name: prep-parallel
description: Initialize parallel git worktree directories for parallel development
args:
  - name: feature_name
    description: Name of the feature for worktree organization
    required: true
  - name: num_worktrees
    description: Number of parallel worktrees to create
    required: true
    default: "3"
---
