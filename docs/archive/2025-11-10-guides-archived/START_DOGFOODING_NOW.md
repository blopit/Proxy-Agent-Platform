...
EOF
  ...
  *)
    ...
    echo ""
    echo "Usage:"
    echo "  ./scripts/dogfood.sh start              - Start API server"
    echo "  ./scripts/dogfood.sh tasks              - List available tasks"
    echo "  ./scripts/dogfood.sh register           - Register yourself"
    echo "  ./scripts/dogfood.sh assign <task_id>   - Assign task to yourself"
    echo "  ./scripts/dogfood.sh accept <assign_id> - Accept assignment"
    echo "  ./scripts/dogfood.sh complete <id> <hrs> - Complete with hours"
    echo "  ./scripts/dogfood.sh my-work            - Show your work"
    echo ""
    echo "Quick workflow:"
    echo "  1. ./scripts/dogfood.sh register"
    echo "  2. ./scripts/dogfood.sh tasks"
    echo "  3. ./scripts/dogfood.sh assign <task_id>"
    echo "  4. ./scripts/dogfood.sh accept <assignment_id>"
    echo "  5. # Do the work"
    echo "  6. ./scripts/dogfood.sh complete <assignment_id> 6.5"
    ;;
esac
```
...
./scripts/dogfood.sh register
./scripts/dogfood.sh tasks
./scripts/dogfood.sh assign <task_id>
./scripts/dogfood.sh accept <assignment_id>
# Build the feature...
./scripts/dogfood.sh complete <assignment_id> 6.5
```
